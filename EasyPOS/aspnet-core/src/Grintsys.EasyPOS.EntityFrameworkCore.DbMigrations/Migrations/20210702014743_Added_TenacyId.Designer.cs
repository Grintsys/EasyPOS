...
namespace Grintsys.EasyPOS.Migrations
{
    ...
    [Migration("20210702014743_Added_TenacyId")]
    partial class Added_TenacyId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.ConfigurationManager.ConfigurationManager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppConfigurationManager");
                });

            modelBuilder.Entity("Grintsys.EasyPOS.CreditNote.CreditNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.CreditNote.CreditNoteItem", b =>
                {
                    ...
                    b.ToTable("AppCreditNoteItems");
                });

            modelBuilder.Entity("Grintsys.EasyPOS.Customer.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.DebitNote.DebitNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Order.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.BankCheck", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBankChecks");
                });

            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.Cash", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.CreditDebitCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CertificateRetentionNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.WireTransfer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Product.ProductWarehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppProductWarehouses");
                });

            modelBuilder.Entity("Grintsys.EasyPOS.Product.Warehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Sincronizador.Sincronizador", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.CreditNote.CreditNote", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.Customer.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.CreditNote.CreditNoteItem", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.CreditNote.CreditNote", "CreditNote")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.DebitNote.DebitNoteItem", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.DebitNote.DebitNote", "DebitNote")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.BankCheck", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.PaymentMethod.PaymentMethod", "PaymentMethod")
                        .WithMany("BankChecks")
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.Cash", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.PaymentMethod.PaymentMethod", "PaymentMethod")
                        .WithOne("Cash")
                        .HasForeignKey("Grintsys.EasyPOS.PaymentMethod.Cash", "PaymentMethodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.CreditDebitCard", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.PaymentMethod.PaymentMethod", "PaymentMethod")
                        .WithOne("CreditDebitCard")
                        .HasForeignKey("Grintsys.EasyPOS.PaymentMethod.CreditDebitCard", "PaymentMethodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.PaymentMethod", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.Order.Order", "Order")
                        ...
                        .HasForeignKey("Grintsys.EasyPOS.PaymentMethod.PaymentMethod", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.WireTransfer", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.PaymentMethod.PaymentMethod", "PaymentMethod")
                        .WithOne("WireTransfer")
                        .HasForeignKey("Grintsys.EasyPOS.PaymentMethod.WireTransfer", "PaymentMethodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Product.ProductWarehouse", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.Product.Product", "Product")
                        .WithMany("ProductWarehouse")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Grintsys.EasyPOS.Product.Warehouse", "Warehouse")
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.PaymentMethod.PaymentMethod", b =>
                {
                    b.Navigation("BankChecks");

                    b.Navigation("Cash");

                    b.Navigation("CreditDebitCard");

                    b.Navigation("WireTransfer");
                });
