...
namespace Grintsys.EasyPOS.Migrations
{
    ...
    [Migration("20210313040114_Added_Order_And_OrderItem_Entity")]
    partial class Added_Order_And_OrderItem_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Models.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Models.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Models.Order", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.Models.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Grintsys.EasyPOS.Models.OrderItem", b =>
                {
                    b.HasOne("Grintsys.EasyPOS.Models.Order", "Order")
                        .WithMany("OrderItems")
